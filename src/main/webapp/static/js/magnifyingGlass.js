...
window.onload = function(){
    ...
    //magnifier.init({
    // cont : document.getElementById('licesePicMagnifier'),
    // img : document.getElementById('licesePicMagnifierImg'),
    // mag : document.getElementById('licesePicM'),
    // scale : 3
    // });
}//欢迎来到站长特效网，我们的网址是www.zzjs.net，很好记，zz站长，js就是js特效，本站收集大量高质量js代码，还有许多广告代码下载。</script>